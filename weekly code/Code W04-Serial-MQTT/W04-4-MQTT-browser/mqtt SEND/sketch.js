...
function setup() {
  ...
  console.log('setup incolor'+inColor);
  createSliders();
...
function onMessageArrived(message) {
 ...
 console.log('incolor before parse ' + inColor);
  // parse the incoming string
  elements = currentString.slice(1); // remove start byte
  elements = elements.toString().split(","); // split on commas
  console.log(elements);
  if ( isNaN(elements[0]) || isNaN(elements[1]) || isNaN(elements[2])){ // r=='NAN' fails quitely
